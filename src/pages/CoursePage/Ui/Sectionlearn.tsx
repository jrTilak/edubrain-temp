    ...
    return (
        <div className='py-16'>
            ...
            <div className='flex justify-center gap-6 max-lg:flex-col m-4 max-sm:m-2 max-lg:m-2'>
                ...
                <div className='flex flex-col gap-10 max-sm:gap-4 max-lg:gap-4'>
