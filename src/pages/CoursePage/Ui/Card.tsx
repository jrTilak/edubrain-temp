        ...
        <>
            <div className='flex  justify-center pt-[100px]'>
                <div className='flex flex-col'>
                    ...
                    <div className='flex justify-center'>
                        <span className='text-[48px] font-900 pt-0 text-white text-center max-sm:text-[24px]'> Why you should become</span>
                    </div>
                    <div className='flex justify-center'>
                        <span className='text-[48px] font-900 pt-0 text-white max-sm:text-[24px]'> UI/UX Designer ? </span>
                    </div>
                </div>
            </div>
