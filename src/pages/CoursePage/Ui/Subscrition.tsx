        ...
        <div className='m-2'>
            ...
            <div className='flex gap-12 justify-center max-sm:flex-col max-lg:gap-2 py-10 max-lg:hidden'>
                <div className='flex justify-center'>
                    <div className='flex flex-col gap-6 bg-[#121721] p-10 w-[600px] max-sm:w-[340px] rounded-xl'>
                        ...
                        <div className='flex  gap-4'>
                            <img src={tick} alt="" />
                            <p className='text-[20px] text-white'>Access to all courses materials</p>
                        </div>
                        <div className='flex  gap-4'>
                            <img src={tick} alt="" />
                            <p className='text-[20px] text-white'>Self-paced learning</p>
                        </div>
                        <div className='flex  gap-4'>
                            <img src={tick} alt="" />
                            <p className='text-[20px] text-white'>Certificate of completion</p>
                        </div>
                ...
                <div className='flex flex-col gap-6 bg-[#121721] p-10 w-[600px] max-sm:w-[410px] rounded-xl border border-[#FF9300]'>
                    ...
                    <div className='flex  gap-4'>
                        <img src={tick} alt="" />
                        <p className='text-[20px] text-white'>Dedicated mentor support</p>
                    </div>
                    <div className='flex  gap-4'>
                        <img src={tick} alt="" />
                        <p className='text-[20px] text-white'>Interactive live sessions</p>
                    </div>
                    <div className='flex  gap-4'>
                        <img src={tick} alt="" />
                        <p className='text-[20px] text-white'>Engaging assignments and projects</p>
                    </div>
                    <button className='bg-[#FF9300] text-white px-6 py-4 rounded-xl'>Upgrade to Premium Excellence</button>
                </div>
            </div>
            <div className='py-4 max-lg:px-6 flex justify-center max-sm:hidden'>
                <img src={refer} alt="" />
            </div>
