      ...
      <div className="my-16">
        <div className="">
          <div className="flex justify-between items-center mb-4">
            <h1 className="text-[24px] text-[#F9F5FF] font-semibold">
              Workshop
            </h1>
            <Link className="text-base text-[#F9F5FF] font-normal">
              Seel All
            </Link>
          </div>
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center gap-8">
              <div className="relative inline-block text-left">
                <select className="appearance-none bg-[#141414]  py-2 px-5 rounded-lg border border-[#252526] text-[#F9F5FF] cursor-pointer">
